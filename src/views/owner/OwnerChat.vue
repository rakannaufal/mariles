    ...
    <main class="main">
      ...
      <aside class="conversations-panel" :class="{ 'mobile-hidden': !showMobileList }">
        ...
        <div v-else class="conversation-list">
          <div v-if="chatRooms.length === 0" class="empty-conversations">
            ...
            <span class="hint">Percakapan dengan guru dan siswa akan muncul di sini</span>
          </div>
      ...
      <div class="chat-window" :class="{ 'mobile-visible': !showMobileList }">
        ...
        <div v-else class="empty-chat">
          ...
          <h2>Mulai Chat</h2>
          <p>Pilih percakapan dari daftar untuk membalas pesan.</p>
        </div>
      </div>
      </div>
    </main>
...
.conversation-item.active {
  background: rgba(13, 87, 130, 0.12);
}
...
.input-wrapper {
  ...
  gap: 12px;
  padding: 8px;
  background: rgba(13, 87, 130, 0.05);
  border-radius: var(--radius-xl);
...
.input-wrapper:focus-within {
  ...
  box-shadow: 0 0 0 4px rgba(13, 87, 130, 0.15);
}
